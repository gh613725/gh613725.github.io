...
var (
	feeds = []string{
    'https://rsshub.moeyy.cn/36kr/information/web_news',
    'https://rsshub.moeyy.cn/huxiu/article',
    'https://rsshub.moeyy.cn/zhihu/hotlist',
    'https://rsshub.moeyy.cn/zhihu/daily',
    'https://rsshub.moeyy.cn/hupu/all/topic-daily',
    'https://rsshub.moeyy.cn/ltaaa',
    'https://rsshub.moeyy.cn/juejin/trending/all/weekly',
    'https://rsshub.moeyy.cn/chouti/hot',
    'https://rsshub.moeyy.cn/owspace/read/0',
    'https://rsshub.moeyy.cn/bilibili/popular/all',
    'https://rsshub.moeyy.cn/xinpianchang/discover',
    'https://rsshub.moeyy.cn/kaiyan/index',
    'https://rsshub.moeyy.cn/xyzrank',
	}

	// Show up to 60 days of posts
	relevantDuration = 1 * 24 * time.Hour
